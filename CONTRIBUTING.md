...
# Contributing to terraform-provider-nsx-intervlan-routing
...
``` shell
git remote add upstream https://github.com/technofish-au/terraform-provider-nsx-intervlan-routing.git
